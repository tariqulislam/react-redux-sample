...
import './assets/plugins/bootstrap-slider/css/bootstrap-slider.min.css';
              ...
              <p>Informational</p>
                ...
                <Nav.Item as="footer" className="main-footer">
                  <Nav.Item className="float-right d-none d-sm-block">
                    <Nav.Item as="b">Version </Nav.Item>
                    3.0.4
                  </Nav.Item>
                  
                  <Nav.Item as="strong">
                    Copyright &copy; 2014-2019
                    <Nav.Item as="a" href="http://adminlte.io"> AdminLTE.io.</Nav.Item>
                  </Nav.Item>
                  <Nav.Item as="a"> All rights reserved.</Nav.Item>
                </Nav.Item>
